...
zmq_proxy.create_proxy(platformConfig.dao_proxy_config            );
zmq_proxy.create_proxy(platformConfig.dao_perms_propagator_config );
zmq_proxy.create_proxy(platformConfig.tracklet_proxy_config       );
