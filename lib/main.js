...
var tracklet_worker_conf = {
   sink : {spec:'tcp://127.0.0.1:49502', bind:true,  id:'q1', type:'pull' },
   tracklet : {
      piwik : {
         token_auth : '90871c8584ddf2265f54553a305b6ae1',
         domain : 'http://localhost:8888/piwik/'
...
dao.dao_proxy(dao_perms_propagator_config);
dao.perms_prop_worker(perms_propagator_b);
...
trackletworker(tracklet_worker_conf)
