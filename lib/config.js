...
var platform = {
   mongrel_handler : {
      ...
      sink   : { spec:'tcp://127.0.0.1:42000', bind:false, type: 'pub',  isMongrel2:true, id:'c' }
   },
   logger_params : {
...
var cloudlet_config = {
   ...
   logger_params : {
      'path'     : '/opt/peat/cloudlet_platform/logs/cloudlet_api',
      'log_level': 'debug',
      'as_json'  : false
   },
...
var object_config = {
   ...
   logger_params : {
      'path'     : '/opt/peat/cloudlet_platform/logs/object_api',
      'log_level': 'debug',
      'as_json'  : false
   },
   trusted_security_framework_public_key: '-----BEGIN PUBLIC KEY-----\n'+
...
var attachment_config = {
   ...
   logger_params : {
      'path'     : '/opt/peat/cloudlet_platform/logs/attachment_api',
      'log_level': 'debug',
      'as_json'  : false
   },
   trusted_security_framework_public_key: '-----BEGIN PUBLIC KEY-----\n'+
...
module.exports.cloudlet_config              = cloudlet_config
module.exports.object_config                = object_config
module.exports.attachment_config            = attachment_config
module.exports.search_config                = search_config
module.exports.type_config                  = type_config
module.exports.perms_config                 = perms_config
...
module.exports.crud_config                  = crud_config
