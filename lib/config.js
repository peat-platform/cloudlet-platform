...
var logging = {
   ...
   "log_level"     : "info",
   "log_file_name" : "/opt/peat/cloudlet_platform/logs/cloudletPlatform.log"
}


var platform = {
   couchbase_cluster : 'couchbase://127.0.0.1:8091',
...
var perms_propagator_b = {spec:'tcp://127.0.0.1:49701', bind:false, id:'perms_b', type:'pull', couchbase_cluster: 'couchbase://127.0.0.1:8091' }
